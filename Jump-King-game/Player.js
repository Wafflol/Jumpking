...
class Player {
    ...
    returnMetadata(){
        ...
        console.log(this.currentPos + this.currentLines);
    ...
    numJump(percent){
        ...
        let verticalJumpSpeed = map(percent * maxJumpTimer, 0, maxJumpTimer, minJumpSpeed, maxJumpSpeed)
